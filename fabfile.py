"""
Starter fabfile for deploying the corredor project.
...
# CHANGEME
env.hosts = ['user@corredor.example.com']
env.code_dir = '/srv/www/corredor'
env.project_dir = '/srv/www/corredor/corredor'
env.static_root = '/srv/www/corredor/static/'
env.virtualenv = '/srv/www/corredor/.virtualenv'
env.code_repo = 'git@github.com:user/corredor.git'
env.django_settings_module = 'corredor.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/corredor/wsgi.py" % env.code_dir)
