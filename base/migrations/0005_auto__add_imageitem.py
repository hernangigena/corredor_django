...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contentitem_base_imageitem', (
        ...
        db.send_create_signal(u'base', ['ImageItem'])


    def backwards(self, orm):
        # Deleting model 'ImageItem'
        db.delete_table(u'contentitem_base_imageitem')
    ...
    models = {
        ...
        u'base.imageitem': {
            'Meta': {'ordering': "('placeholder', 'sort_order')", 'object_name': 'ImageItem', 'db_table': "u'contentitem_base_imageitem'", '_ormbases': ['fluent_contents.ContentItem']},
